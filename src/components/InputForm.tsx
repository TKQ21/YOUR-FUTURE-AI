...
export default function InputForm({ onSimulate, isLoading }: InputFormProps) {
  ...
  return (
    <motion.form
      ...
      className="p-6 md:p-8 rounded-2xl bg-card border border-border neon-glow-blue space-y-6"
    >
      <div className="space-y-2">
        <Label htmlFor="skills" className="text-sm font-display tracking-wider uppercase text-muted-foreground">
          Your Current Skills
        </Label>
        <Input
          id="skills"
      ...
      <div className="space-y-2">
        <Label htmlFor="goal" className="text-sm font-display tracking-wider uppercase text-muted-foreground">
          Career Goal
        </Label>
        <Input
          id="goal"
      ...
      <Button
        ...
        className="w-full gradient-main text-primary-foreground font-display tracking-wider text-lg py-6 hover:opacity-90 transition-opacity"
        size="lg"
      >
        {isLoading ? (
